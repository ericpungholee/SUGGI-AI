...
import StarredDocumentGrid from "@/components/home/StarredDocumentGrid";
        ...
        <div className="flex h-screen bg-stone-light">
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <main className="flex-1 overflow-y-auto px-8 py-6">
                    <div className="mb-6">
                        <h1 className="text-2xl font-bold text-ink mb-2">Starred Documents</h1>
                        <p className="text-ink/60">Your favorite and important documents</p>
                    </div>
